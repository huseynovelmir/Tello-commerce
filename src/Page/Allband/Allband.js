...
import { getAllband } from "../../store/Reducer/AllBandreducer"
...
import Allbandswiper from "./Allbandswiper"
function Allband() {

    const {
        qolbaqlarproducts,
        qolbaqlarloading
    } = useSelector((state) => state.Allband)
    const dispatch3 = useDispatch()


    useEffect(() => {
        dispatch3(getAllband())
    }, [])

console.log(qolbaqlarproducts);
...
console.log(click);
    return (
        qolbaqlarloading ? < div className = "loading-container-main" >
            <img className='loading' src={loadingimg} alt="" />

        </div> :
            <div className="container">
                <Link className='link' to="/">  Ana sehife  <img src={arrow} alt="" /> {qolbaqlarproducts?.[0]?.categories?.[2]?.name}</Link>
                <div className='main-area'>
                    ...
                    <div className="part-1">
                        <div className="brend-container">
                            ...
                            <h5>{qolbaqlarproducts.length} Məhsul tapıldı</h5>
                    ...
                    < Allbandswiper qolbaqlarproducts = {
qolbaqlarproducts
                    }
                    qolbaqlarloading = {
                        qolbaqlarloading

...
import { getAllqulaqciq } from "../../store/Reducer/Qulaqciqreducer"
...
import Allqulaqciqswiper from "./Allqulaqciqswiper"
function Allqulaqciq() {

    const {
        qulaqciqlarproducts,
        qulaqciqlarloading
    } = useSelector((state) => state.allqulaqciq)
    const dispatch3 = useDispatch()


    useEffect(() => {
        dispatch3(getAllqulaqciq())
    }, [])

console.log(qulaqciqlarproducts);
...
console.log(click);
    return (
        qulaqciqlarloading ? < div className = "loading-container-main" >
            <img className='loading' src={loadingimg} alt="" />

        </div> :
            <div className="container">
                <Link className='link' to="/">  Ana sehife  <img src={arrow} alt="" /> {qulaqciqlarproducts?.[0]?.categories?.[1]?.name}</Link>
                <div className='main-area'>
                    ...
                    <div className="part-1">
                        <div className="brend-container">
                            ...
                            <h5>{qulaqciqlarproducts.length} Məhsul tapıldı</h5>
                    ...
                    < Allqulaqciqswiper qulaqciqlarproducts = {
qulaqciqlarproducts
                    }
                    qulaqciqlarloading = {
                        qulaqciqlarloading

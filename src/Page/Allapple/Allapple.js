...
import Allsamsungswiper from "../Allapple/Allappleswiper"
...
function Allapple() {
    ...
    const {
        appleproduct,
        appleloading
    } = useSelector((state) => state.alliphone)
...
console.log(click);
    return (
        appleloading ? < div className = "loading-container-main" >
            <img className='loading' src={loadingimg} alt="" />

        </div> :
            <div className="container">
                <Link className='link' to="/">  Ana sehife  <img src={arrow} alt="" /> {appleproduct?.[0]?.categories?.[1]?.name}</Link>
                <div className='main-area'>
                    ...
                    <div className="part-1">
                        <div className="brend-container">
                            ...
                            <h5>{appleproduct.length} Məhsul tapıldı</h5>

...
import Allhonorswiper from "../Allhonor/Allhonorswiper"

import { useEffect } from "react"

import { useSelector, useDispatch } from "react-redux"
import { getHonor } from "../../store/Reducer/honorreducer"
...
function Allhonor() {
    ...
    const {
        honorproduct,
        honorloading
    } = useSelector((state) => state.allhonor)
...
console.log(click);
    return (
        honorloading ? < div className = "loading-container-main" >
            <img className='loading' src={loadingimg} alt="" />

        </div> :
            <div className="container">
                <Link className='link' to="/">  Ana sehife  <img src={arrow} alt="" /> {honorproduct?.[0]?.categories?.[1]?.name}</Link>
                <div className='main-area'>
                    ...
                    <div className="part-1">
                        <div className="brend-container">
                            ...
                            <h5>{honorproduct.length} Məhsul tapıldı</h5>

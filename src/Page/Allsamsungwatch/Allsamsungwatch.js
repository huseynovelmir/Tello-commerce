...
import { getallsamsungwatch } from "../../store/Reducer/Allsamsungwatchreducer"
...
import Allsamsungwatchswiper from "./Allsamsungwatchreducer"
function Allsamsungwatch() {

    const {
        samsungwatchproducts,
        samsungwatchloading
    } = useSelector((state) => state.allsamsungwatch)
    const dispatch3 = useDispatch()


    useEffect(() => {
        dispatch3(getallsamsungwatch())
    }, [])

console.log(samsungwatchproducts);
...
console.log(click);
    return (
        samsungwatchloading ? < div className = "loading-container-main" >
            <img className='loading' src={loadingimg} alt="" />

        </div> :
            <div className="container">
                <Link className='link' to="/">  Ana sehife  <img src={arrow} alt="" /> {samsungwatchproducts?.[0]?.categories?.[2]?.name}</Link>
                <div className='main-area'>
                    ...
                    <div className="part-1">
                        <div className="brend-container">
                            ...
                            <h5>{samsungwatchproducts.length} Məhsul tapıldı</h5>
                    ...
                    < Allsamsungwatchswiper samsungwatchproducts = {
samsungwatchproducts
                    }
                    samsungwatchloading = {
                        samsungwatchloading
...
export default Allsamsungwatch

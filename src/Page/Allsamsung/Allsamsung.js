...
import Allsamsungswiper from "../Allsamsung/Allsamsungswiper"
...
console.log(click);
    return (
        samsungloading ? < div className = "loading-container-main" >
            <img className='loading' src={loadingimg} alt="" />

        </div> :
            <div className="container">
                <Link className='link' to="/">  Ana sehife  <img src={arrow} alt="" /> {samsungproduct?.[0]?.categories?.[1]?.name}</Link>
                <div className='main-area'>
                    ...
                    <div className="part-1">
                        <div className="brend-container">
                            ...
                            <h5>{samsungproduct.length} Məhsul tapıldı</h5>
                    ...
                    < Allsamsungswiper samsungproduct = {
samsungproduct
                    }
                    samsungloading = {
                        samsungloading
